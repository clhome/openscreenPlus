      ...
      <div className="absolute right-0 top-full mt-2 w-64 bg-[#09090b] border border-white/10 rounded-lg p-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 shadow-xl z-50">
        ...
        <div className="space-y-1.5 text-[10px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <kbd className="px-1 py-0.5 bg-white/5 border border-white/10 rounded text-[#34B27B] font-mono">C</kbd>
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between">
            ...
            <kbd className="px-1 py-0.5 bg-white/5 border border-white/10 rounded text-[#34B27B] font-mono">X</kbd>
          </div>
          <div className="flex items-center justify-between">
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 bg-[#09090b] border border-white/10 rounded-xl p-4 z-50 shadow-2xl">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div
                  className={`flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-colors ${editingKey === 'stopRecording'
              ...
              <div className="space-y-1.5">
                ...
                <div
                  className={`flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-colors ${editingKey === 'pauseRecording'
                    ? 'bg-[#34B27B]/20 border border-[#34B27B]/50'
                    : 'bg-white/5 hover:bg-white/10 border border-transparent'
                    }`}
