            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <ToggleGroup 
                  ...
                  onValueChange={(value) => value && onStyleChange({ textAlign: value as 'left' | 'center' | 'right' })}
                      ...
                      >
                        <div 
                          className={cn(
                            ...
                            annotation.style.backgroundColor === 'transparent' && "bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI4IiBoZWlnaHQ9IjgiPjxyZWN0IHdpZHRoPSI0IiBoZWlnaHQ9IjQiIGZpbGw9IiNjY2MiLz48cmVjdCB4PSI0IiB5PSI0IiB3aWR0aD0iNCIgaGVpZ2h0PSI0IiBmaWxsPSIjY2NjIi8+PC9zdmc+')] bg-repeat"
                          )}
                          style={{ 
                            backgroundColor: annotation.style.backgroundColor === 'transparent' ? undefined : annotation.style.backgroundColor 
                          }}
                        />
                        <span className="text-xs text-slate-300 truncate flex-1 text-left">
