...
import { Trash2, Download, Crop, X, Upload } from "lucide-react";
import { toast } from "sonner";
import type { ZoomDepth, CropRegion, AnnotationRegion, AnnotationType, ZoomMode } from "./types";
...
export function SettingsPanel({
  ...
  padding: _padding = 50,
  onPaddingChange: _onPaddingChange,
  cropRegion,
  onCropChange,
  aspectRatio,
  videoElement,
  ...
  zoomMode: _zoomMode = 'fixed',
  onZoomModeChange: _onZoomModeChange,
}: SettingsPanelProps) {
  ...
  return (
    <div className="w-full bg-[#09090b] border border-white/5 rounded-2xl p-4 flex flex-col shadow-xl min-h-full">
      ...
      <div className="mb-6">
        ...
        {/* Zoom Mode Selector - 暂时隐藏，默认使用固定模式 */}
      ...
      <div className="mb-4">
        <div className="grid grid-cols-2 gap-2.5">
          ...
          {/* Padding Slider (Hidden by default as per requirement) */}
